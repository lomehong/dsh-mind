...
export declare const DEFAULT_PROMPT_BLOCKS: PromptBlocks;
/** 装配唤醒提示词（纯函数）。blocks 缺省用内置四块；心智 Tab 的覆盖层经
 *  resolveWakePromptBlocks() 解析后传入。 */
export declare function buildWakePrompt(inputs: WakePromptInputs, blocks?: PromptBlocks): string;
